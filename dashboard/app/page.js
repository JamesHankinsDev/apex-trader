...
const STEPS = [
  ...
  { label: 'Dashboard prototype components', done: true },
  ...
  { label: 'Port prototype components to ES modules', done: false },
];
  ...
  return (
    ...
    >
      <div style={{ width: '100%', maxWidth: 520 }}>
        ...
        <p style={{ font: '14px var(--font-sans)', color: 'var(--text-500)', margin: '0 0 24px' }}>
